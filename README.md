...
### 要件
- githubに公開する(GitHub Pagesにしても、README.mdのままでも構わない)
- README.mdに以下を掲載する
...
## 進め方一例
- GitHubに公開用のリポジトリーを作成
- README.mdに、現時点で決まっていることを入力しておく
- GitHub Pagesを設定
- Issuesに簡単な作業手順を作成
- 開発
  - シーン遷移があれば実装
  - リソースを読み込み(フォントなど)
  - TextMesh Proなど仕込んでおく
  - タイトル画面を作成
  - ゲーム画面のレイアウトをある程度仕上げる
  - 中身の開発開始。演出は後回しにして、ゲームの基本ロジックを組み立てる
- 1時間経過時点で、一旦スクリーンショットをとって、README.mdを更新
- 必要に応じて、残り時間で仕上げられる内容に企画を修正
- 残り30分で、一旦スクリーンショットをとって、README.mdを更新
- 必要に応じて、残り時間で仕上げられる内容に企画を修正
